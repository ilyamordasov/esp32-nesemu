...
spi = machine.SPI(2, sck=machine.Pin(19), mosi=machine.Pin(23), miso=machine.Pin(25))
flash = W25QFlash(spi=spi, cs=machine.Pin(14), baud=20_000_000, software_reset=True)

flash_mount_point = '/roms'
...
sys.path.append(flash_mount_point)
print(uos.listdir())
print(sys.path)