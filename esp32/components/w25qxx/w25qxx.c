...
static const esp_partition_t* add_partition(esp_flash_t* ext_flash, const char* partition_label)
{
    ...
    const size_t offset = 0x200000;
    ESP_ERROR_CHECK(esp_partition_register_external(ext_flash, offset, /*ext_flash->size*/0x600000, partition_label, ESP_PARTITION_TYPE_DATA, ESP_PARTITION_SUBTYPE_DATA_FAT, &fat_partition));
